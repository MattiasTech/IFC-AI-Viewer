...
export class ViewerApp {
  ...
  console.log('[viewer] model parsed and added to scene (docs)', { name: file.name, model });
  ...
  console.log('[viewer] frameModel bounding box (docs)', box.min.toArray(), box.max.toArray());
    if (!box.isEmpty()) {
  ...
  console.log('[viewer] camera positioned to frame model (docs)', { position: this.camera.position.toArray(), target: this.controls.target.toArray() });
    }
  }
